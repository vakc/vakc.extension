...
print('-' * 100)
# Overall Total Cost
overall_total_cost = columns_total_cost + Framing_total_cost + walls_total_cost + floor_total_cost + windows_doors_total_cost + railing_total_cost + furniture_total_cost
